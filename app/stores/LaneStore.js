...
class LaneStore {
  ...
  // If a lane is deleted, it would be a good idea to get rid of the
  // associated notes as well.
  // In the current implementation they are left hanging in the NoteStore.
  delete(id) {
    this.setState({
